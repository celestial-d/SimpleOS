...
static char* shell_functions[] = {
        ...
        "mkdir dirname: create directory. example: mkdir tmp",
        "touch filename: create file. example: touch tmp",
        "rm [dirname|filename]: delete dir or file. example: rm /tmp",
        "echo: writes data to a file. example: echo test >> tmp",
        "cat filname: view file content. example: cat tmp",
